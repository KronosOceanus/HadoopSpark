...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.addCacheFile(new URI("hdfs://node1:8020/input/cache/products.txt"));
//        DistributedCache.addCacheFile(new URI("hdfs://node1:8020/input/cache/products.txt"),
//                super.getConf());

        job.setInputFormatClass(TextInputFormat.class);
        TextInputFormat.addInputPath(job, new Path("hdfs://node1:8020/input/mapjoin"));
        ...
        Path path = new Path("hdfs://node1:8020/output/mapjoin_out");
