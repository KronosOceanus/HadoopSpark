...
//  /usr/local/kafka/bin/kafka-topics.sh --delete --zookeeper node1:2181 --topic iotTopic
//  /usr/local/kafka/bin/kafka-topics.sh --create --zookeeper node1:2181 --topic iotTopic --partitions 3 --replication-factor 1
//  /usr/local/kafka/bin/kafka-console-consumer.sh --topic iotTopic --bootstrap-server node1:9092 --from-beginning
