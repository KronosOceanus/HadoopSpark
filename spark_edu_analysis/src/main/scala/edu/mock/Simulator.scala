...
object Simulator {
  ...
  //教材ID
  val arr2: Array[String] = Array("教材ID_1", "教材ID_2")
  //年级ID
  val arr3: Array[String] = Array("年级ID_1", "年级ID_2", "年级ID_3", "年级ID_4", "年级ID_5", "年级ID_6")
  //科目ID
  val arr4: Array[String] = Array("科目ID_1_数学", "科目ID_2_语文", "科目ID_3_英语")
  //章节ID
  val arr5: Array[String] = Array("章节ID_chapter_1", "章节ID_chapter_2", "章节ID_chapter_3")

  //题目ID与教材、年级、科目、章节的对应关系,
  val questionMap: mutable.Map[String, ArrayBuffer[String]] = collection.mutable.HashMap[String, ArrayBuffer[String]]()
  ...
  def genQuestion(): Any = {
    ...
    Answer(studentID, textbookIDRandom, gradeIDRandom, subjectIDRandom, chapterIDRandom,
      questionIDRandom, deductScoreRandom, answerTime, timestamp)
  }
